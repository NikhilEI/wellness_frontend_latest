...
export default function AdminOrderDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <>
            ...
            <div className="card">
              ...
              <div className="card-body">
                ...
                {data.order.payment_status !== "paid" && (
                  <button type="button" className="btn btn-success w-100 mt-3" onClick={markPaid} disabled={updating}>
      ...
      <Link href="/exhibitor-zone/admin/orders" className="btn btn-outline-primary">
